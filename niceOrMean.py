    ...
    if name !="":
        ...
        while stop:
            if name == "":
                ...
                if name != "":
                    print("\nWelcome, {}!".format(name))
                    print("\nIn this game, you will be greeeted \nby several different people. \nYou can choose to be nice or mean")
...
def nice_mean(nice,mean,name):
    ...
    while stop:
        ...
        pick = input("\nYour friend needs a last minute ride to work,\nwill you be nice and help\nor be mean and say no? (N/M) \n>>>: ").lower()
        if pick == "n":
            print("\nYou are now best friends...")
            nice = (nice + 1)
            stop = False
        if pick == "m":
            print("That is not how friendship lasts...")
            mean = (mean + 1)
            stop = False
