...
def load_gui(self):
        self.btn_browse1 = tk.Button(self.master,command=lambda:scriptFunc.path(self), width=15,height=1,bg='lightgray',text="Browse...")
        self.btn_browse1.grid(row=2,column=0,padx=(25,0),pady=(50,0))
        self.btn_browse2 = tk.Button(self.master,command=lambda:scriptFunc.path2(self), width=15,height=1,bg='lightgray',text="Browse...")
        ...
        self.first_browse = Text(self.master,width=40,height=1)
        self.first_browse.grid(row=2,column=1,columnspan=10,padx=(10,0),pady=(50,0))
        self.second_browse = Text(self.master,width=40,height=1)
