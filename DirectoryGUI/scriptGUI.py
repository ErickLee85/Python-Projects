...
def load_gui(self):
        self.btn_browse1 = tk.Button(self.master,command=lambda:scriptFunc.Source(self), width=15,height=1,bg='lightgray',text="Source...")
        self.btn_browse1.grid(row=2,column=0,padx=(25,0),pady=(50,0))
        self.btn_browse2 = tk.Button(self.master,command=lambda:scriptFunc.Destination(self), width=15,height=1,bg='lightgray',text="Destination...")
        self.btn_browse2.grid(row=3,column=0,padx=(25,0),pady=(12,0))
        self.btn_check = tk.Button(self.master,command=lambda: scriptFunc.CheckFile(self), width=15,height=2,bg='lightgray',text="Run Program")
        ...
        self.first_browse = Entry(self.master,width=80)
        self.first_browse.grid(row=2,column=1,columnspan=10,padx=(10,0),pady=(50,0))
        self.second_browse = Entry(self.master,width=80)
